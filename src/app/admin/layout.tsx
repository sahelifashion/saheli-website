...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-80px)] bg-gray-50">
      {/* Sidebar */}
      <aside className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200 p-4 md:p-6 flex-shrink-0">
        <div className="mb-4 md:mb-8">
          <h2 className="text-xl font-bold text-brand-maroon hidden md:block">Admin Panel</h2>
        </div>
        <nav className="flex md:flex-col gap-2 overflow-x-auto pb-2 md:pb-0 md:space-y-2 md:space-x-0">
